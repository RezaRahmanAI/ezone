...
{
    [Authorize]
    [RoutePrefix("barcodesales-order")]
    public class BarcodeSalesOrderController : CoreController //For TR Electronics Barcode Sale
    {
        ...
        public BarcodeSalesOrderController(IErrorService errorService,
            ...
            ISystemInformationService SysInfoService, ISMSStatusService SMSStatusService,
            ICardTypeSetupService CardTypeSetupService, ICardTypeService CardTypeService, IBankTransactionService bankTransactionService,ISMSBillPaymentBkashService sMSBillPaymentBkashService,
            ISessionMasterService sessionMasterService, IRoleService roleService, IUserAuditDetailService userAuditDetailService)
        ...
        private void CheckAndAddModelErrorForSave(SalesOrderViewModel newSalesOrder, SalesOrderViewModel salesOrder, FormCollection formCollection)
        {
            ...
            //backdate entry on comment by biplob
        ...
        private DataTable CreateSalesOrderDataTable(SalesOrderViewModel salesOrder)
        {
            ...
            row["CreatedDate"] = salesOrder.SalesOrder.CreateDate.Date;
