...
namespace IMSWEB.Controllers
{
    ...
    public class EmobileSalesOrderController : CoreController
    {
        ...
        public EmobileSalesOrderController(IErrorService errorService,
        ...
        [HttpGet]
        [Authorize]
        public ActionResult FInvoice(int orderId)
        {
            TempData["IsInvoiceReadyById"] = true;
            TempData["FInvoice"] = true;
            TempData["OrderId"] = orderId;
            return RedirectToAction("Index");
        }
