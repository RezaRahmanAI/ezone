    ...
    public class PurchaseOrderController : CoreController
    {
        ...
        private void SaveOrder(PurchaseOrderViewModel newPurchaseOrder, PurchaseOrderViewModel purchaseOrder, FormCollection formCollection, bool IsDeliveryOrder)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //if (isPreview)
                    //{
                    //    var invoicePurchaseOrder = _mapper.Map<CreatePurchaseOrderViewModel, POrder>(purchaseOrder.PurchaseOrder);
                    //    invoicePurchaseOrder.POrderDetails = _mapper.Map<IEnumerable<CreatePurchaseOrderDetailViewModel>, List<POrderDetail>>(purchaseOrder.PODetails);
                    //    TempData["POInvoiceData"] = invoicePurchaseOrder;
        ...
        private ActionResult HandlePurchaseOrder(PurchaseOrderViewModel newPurchaseOrder, FormCollection formCollection, bool IsDeliveryOrder)
        {
            ...
            if (newPurchaseOrder != null)
            {
                ...
                else if (formCollection.Get("submitButton") != null || formCollection.Get("btnPreview") != null)
                {
                    if (!IsDeliveryOrder)
                    ...
                    bool isPreview = formCollection.Get("btnPreview") != null ? true : false;
