...
{
    public partial class TransactionSOrder : IModelBase, IBankPayment
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public TransactionSOrder()
        {
            SOrderDetails = new HashSet<TransactionSOrderDetail>();
        }

        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Key]
        public int TransSOrderID { get; set; }
        ...
        public virtual ICollection<TransactionSOrderDetail> SOrderDetails { get; set; }
