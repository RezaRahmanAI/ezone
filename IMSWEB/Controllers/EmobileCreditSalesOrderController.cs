...
namespace IMSWEB.Controllers
{
    ...
    public class EmobileCreditSalesOrderController : CoreController
    {
        ...
        public EmobileCreditSalesOrderController(IErrorService errorService,
            ...
            CreditSalesOrderViewModel salesOrder, FormCollection formCollection)
        {
            ...
            salesOrder.SODetail.Warranty = newSalesOrder.SODetail.Warranty;
        ...
        private DataTable CreateSODetailDataTable(CreditSalesOrderViewModel salesOrder)
        {
            ...
            foreach (var item in salesOrder.SODetails)
            {
                ...
                row["Spareparts"] = 0;
                row["Service"] = 0;
                row["Warranty"] = GetDefaultIfNull(item.Warranty);
